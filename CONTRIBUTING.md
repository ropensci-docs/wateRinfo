...
First of all, thanks for considering contributing to wateRinfo! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on wateRinfo. 😊

wateRinfo is an open source project, maintained by people who care. We
are not directly funded to do so.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://docs.ropensci.org/wateRinfo/CODE_OF_CONDUCT.md). By
...
Think wateRinfo is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using wateRinfo for a paper you are writing? Consider [citing
it](https://ropensci.github.io/wateRinfo/authors.html).

### Ask a question ⁉️

Using wateRinfo and got stuck? Browse the
[documentation](https://ropensci.github.io/wateRinfo) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/ropensci/wateRinfo/issues/new). While we
...
Have an idea for a new wateRinfo feature? Take a look at the
[documentation](https://ropensci.github.io/wateRinfo) and [issue
list](https://github.com/ropensci/wateRinfo/issues) to see if it isn’t
...
Using wateRinfo and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/ropensci/wateRinfo/issues/new) so we can fix
...
[This website](https://ropensci.github.io/wateRinfo) is generated with
...
issue](https://github.com/ropensci/wateRinfo/issues/new) and we can
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/ropensci/wateRinfo).
...
Care to fix bugs or implement new functionality for wateRinfo? Awesome!
👏 Have a look at the [issue
list](https://github.com/ropensci/wateRinfo/issues) and leave a comment
...
1.  Fork [this repo](https://github.com/ropensci/wateRinfo) and clone it
